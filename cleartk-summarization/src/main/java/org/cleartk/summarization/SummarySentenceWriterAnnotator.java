...
public class SummarySentenceWriterAnnotator extends JCasAnnotator_ImplBase {
	...
	public static AnalysisEngineDescription getDescription(File outputFile, boolean writeScores) throws ResourceInitializationException {
		return AnalysisEngineFactory.createPrimitiveDescription(SummarySentenceWriterAnnotator.class, 
	...
	public static final String PARAM_OUTPUT_URI = ConfigurationParameterFactory
			.createConfigurationParameterName(SummarySentenceWriterAnnotator.class,
					"outputUri");
	
	@ConfigurationParameter(mandatory=true)
	protected URI outputUri;

	public static final String PARAM_WRITE_SCORES = ConfigurationParameterFactory
			.createConfigurationParameterName(SummarySentenceWriterAnnotator.class,
					"writeScores");
