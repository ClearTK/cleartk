...
public class TemporalLink_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.cleartk.temporal.timeml.type.TemporalLink");
  ...
  public String getRelationType(int addr) {
      ...
      jcas.throwFeatMissing("relationType", "org.cleartk.temporal.timeml.type.TemporalLink");
  ...
  public int getSource(int addr) {
      ...
      jcas.throwFeatMissing("source", "org.cleartk.temporal.timeml.type.TemporalLink");
  ...
  public int getTarget(int addr) {
      ...
      jcas.throwFeatMissing("target", "org.cleartk.temporal.timeml.type.TemporalLink");
  ...
  public String getId(int addr) {
      ...
      jcas.throwFeatMissing("id", "org.cleartk.temporal.timeml.type.TemporalLink");
  ...
  public String getEventInstanceID(int addr) {
      ...
      jcas.throwFeatMissing("eventInstanceID", "org.cleartk.temporal.timeml.type.TemporalLink");
  ...
  public String getEventID(int addr) {
      ...
      jcas.throwFeatMissing("eventID", "org.cleartk.temporal.timeml.type.TemporalLink");
  ...
  public String getTimeID(int addr) {
      ...
      jcas.throwFeatMissing("timeID", "org.cleartk.temporal.timeml.type.TemporalLink");
  ...
  public String getRelatedToEventInstance(int addr) {
      ...
      jcas.throwFeatMissing("relatedToEventInstance", "org.cleartk.temporal.timeml.type.TemporalLink");
  ...
  public String getRelatedToEvent(int addr) {
      ...
      jcas.throwFeatMissing("relatedToEvent", "org.cleartk.temporal.timeml.type.TemporalLink");
  ...
  public String getRelatedToTime(int addr) {
      ...
      jcas.throwFeatMissing("relatedToTime", "org.cleartk.temporal.timeml.type.TemporalLink");
  ...
  public String getSignalID(int addr) {
      ...
      jcas.throwFeatMissing("signalID", "org.cleartk.temporal.timeml.type.TemporalLink");
  ...
  public TemporalLink_Type(JCas jcas, Type casType) {
    ...
    casFeat_source = jcas.getRequiredFeatureDE(casType, "source", "org.cleartk.temporal.timeml.type.Anchor", featOkTst);
    casFeatCode_source  = (null == casFeat_source) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_source).getCode();

 
    casFeat_target = jcas.getRequiredFeatureDE(casType, "target", "org.cleartk.temporal.timeml.type.Anchor", featOkTst);
