...
public class Event_Type extends Anchor_Type {
  ...
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.cleartk.temporal.timeml.type.Event");
  ...
  public String getEventClass(int addr) {
      ...
      jcas.throwFeatMissing("eventClass", "org.cleartk.temporal.timeml.type.Event");
  ...
  public String getEventInstanceID(int addr) {
      ...
      jcas.throwFeatMissing("eventInstanceID", "org.cleartk.temporal.timeml.type.Event");
  ...
  public String getSignalID(int addr) {
      ...
      jcas.throwFeatMissing("signalID", "org.cleartk.temporal.timeml.type.Event");
  ...
  public String getStem(int addr) {
      ...
      jcas.throwFeatMissing("stem", "org.cleartk.temporal.timeml.type.Event");
  ...
  public String getPos(int addr) {
      ...
      jcas.throwFeatMissing("pos", "org.cleartk.temporal.timeml.type.Event");
  ...
  public String getTense(int addr) {
      ...
      jcas.throwFeatMissing("tense", "org.cleartk.temporal.timeml.type.Event");
  ...
  public String getAspect(int addr) {
      ...
      jcas.throwFeatMissing("aspect", "org.cleartk.temporal.timeml.type.Event");
  ...
  public String getCardinality(int addr) {
      ...
      jcas.throwFeatMissing("cardinality", "org.cleartk.temporal.timeml.type.Event");
  ...
  public String getPolarity(int addr) {
      ...
      jcas.throwFeatMissing("polarity", "org.cleartk.temporal.timeml.type.Event");
  ...
  public String getModality(int addr) {
      ...
      jcas.throwFeatMissing("modality", "org.cleartk.temporal.timeml.type.Event");
