...
In ClearTK, we have always been careful to decouple the machine learning framework from the type system, and all of the machinery for creating classifier-based annotators including feature extraction, feature normalization, chunking, training, classification, etc. is completely type system independent.
