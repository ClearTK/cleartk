...
public class Evaluation {
   ...
   *          training data and testing data for each fold. Please see {@link CorpusReaderFactory}.
   * @param engineFactory
  ...
  public static void runCrossValidation(
      CorpusReaderFactory corpusFactory,
      CleartkAnnotatorFactory engineFactory,
  ...
  public static void run(
    ...
    AnalysisEngine dataWritingAggregate = engineFactory.getTrainingAggregate(runName);
    ...
    AnalysisEngine classifierAggregate = engineFactory.getClassifierAggregate(runName);
    AnalysisEngine evaluationAggregate = evaluationFactory.getEvaluationAggregate(runName);

    for (JCas jCas : new JCasIterable(
        testingReader,
        preprocessing,
        classifierAggregate,
        evaluationAggregate)) {
   ...
   * @param corpusFactory
   *          see
   *          {@link #runCrossValidation(File, CorpusReaderFactory, CleartkAnnotatorFactory, EvaluationFactory, String...)}
   * @param engineFactory
   *          see
   *          {@link #runCrossValidation(File, CorpusReaderFactory, CleartkAnnotatorFactory, EvaluationFactory, String...)}
   * @param evaluationFactory
  ...
  public static void buildCorpusModel(
    ...
    AnalysisEngine dataWritingAggregate = engineFactory.getTrainingAggregate("model");
