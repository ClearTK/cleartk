...
import org.cleartk.type.ContiguousAnnotation_Type;

/** 
 * Updated by JCasGen Fri Dec 05 10:56:21 MST 2008
 * @generated */
public class TreebankNode_Type extends ContiguousAnnotation_Type {
  /** @generated */
  ...
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.cleartk.syntax.treebank.type.TreebankNode");
  ...
  public String getNodeType(int addr) {
      ...
      jcas.throwFeatMissing("nodeType", "org.cleartk.syntax.treebank.type.TreebankNode");
  ...
  public String getNodeValue(int addr) {
      ...
      jcas.throwFeatMissing("nodeValue", "org.cleartk.syntax.treebank.type.TreebankNode");
  ...
  public boolean getLeaf(int addr) {
      ...
      jcas.throwFeatMissing("leaf", "org.cleartk.syntax.treebank.type.TreebankNode");
  ...
  public int getParent(int addr) {
      ...
      jcas.throwFeatMissing("parent", "org.cleartk.syntax.treebank.type.TreebankNode");
  ...
  public int getChildren(int addr) {
      ...
      jcas.throwFeatMissing("children", "org.cleartk.syntax.treebank.type.TreebankNode");
  ...
  public int getNodeTags(int addr) {
      ...
      jcas.throwFeatMissing("nodeTags", "org.cleartk.syntax.treebank.type.TreebankNode");
  ...
  public TreebankNode_Type(JCas jcas, Type casType) {
    ...
    casFeat_parent = jcas.getRequiredFeatureDE(casType, "parent", "org.cleartk.syntax.treebank.type.TreebankNode", featOkTst);
